...
import { ClipboardCheckIcon, HomeIcon, PanelLeftIcon, ShoppingBagIcon, UsersIcon } from "lucide-react"
...
export const NAVIGATION = [
    ...
    { name: "Orders", path: "/orders", icon: <ClipboardCheckIcon className="size-5" /> },
